...
<?php
	...
	$total = (($sbtotal + $customrate + $shipping + $vat) * 100) / 100;
   ...
   <tr><td></td><td class='label'>Subtotal</td><td  class='price'>$<?php echo number_format($sbtotal, 2, '.', '');?></td><td  class='price'><?php echo number_format($subtotal_ksh);?></td><td></td></tr>
    <tr><td></td><td class='label'>Customs &amp; Import Fees</td><td class='price' id="customfee-usd">$<?php echo number_format($customrate, 2, '.', '');?></td><td class='price' id="customfee-ksh"></td></tr>
    <tr><td></td><td class='label'>Shipping &amp; Handling</td><td class='price' id="shippingfee-usd">$<?php echo number_format($shipping, 2, '.', '');?></td><td class='price' id="shipping-ksh"></td></tr>
    <tr><td></td><td class='label'>VAT</td><td class='price' id="vatfee-usd">$<?php echo number_format($vat, 2, '.', '');?></td><td class='price' id="vat-ksh"></td></tr>
    <tr><td></td><td class='label'>Total</td><td class='price' id="totalfee-usd">$<?php echo number_format($total, 2, '.', '');?></td><td class='price' id="total-ksh"></td></tr>
