...
<ol class='faq-answer'>
  ...
  <li>When you are ready to Checkout, click on the VituMob&copy; button <img src="{{ asset('images/favicon.ico') }}"> on your browser.
...
<p class='faq-answer'>There is no need to click the Checkout button on any website. Once you have loaded your shopping cart, please click the VituMob&copy; button <img src="{{ asset('images/favicon.ico') }}"> on your web browser instead.</p>
