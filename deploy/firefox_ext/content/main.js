...
// change hostname to "www.vitumob.com"

			if (doc.location.hostname != "www.ecosandals.com/vm" || doc.location.pathname != "/beta") return;
...
vitu.serverUrl = "http://www.ecosandals.com/vm/beta";
vitu.merchants = {};
